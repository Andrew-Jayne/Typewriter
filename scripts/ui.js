...
function syncSettingsControls() {
    ...
    document.getElementById('toggle-line-numbers').checked = getState({ key: StateKey.SHOW_LINE_NUMBERS });
    document.getElementById('toggle-monospace').checked = getState({ key: StateKey.USE_MONOSPACE });
    document.getElementById('toggle-wide').checked = getState({ key: StateKey.ENABLE_WIDE_MODE });
    document.getElementById('toggle-tooltips').checked = getState({ key: StateKey.SHOW_TOOLTIPS });
    document.getElementById('toggle-word-count').checked = getState({ key: StateKey.SHOW_WORD_COUNT });
    ...
    syncDiyField({ field: 'text', hexColor: getState({ key: StateKey.DIY_TEXT }) });
    syncDiyField({ field: 'accent', hexColor: getState({ key: StateKey.DIY_ACCENT }) });
    syncDiyField({ field: 'border', hexColor: getState({ key: StateKey.DIY_BORDER }) });
}
